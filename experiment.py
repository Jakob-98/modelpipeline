...
class Experiment(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log_dict({f"class_{i}_precision": val for i, val in classwise_precision.tolist()}, sync_dist=True)
        self.log_dict({f"class_{i}_recall": val for i, val in classwise_recall.tolist()}, sync_dist=True)
